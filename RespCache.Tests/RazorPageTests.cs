...
namespace RespCache.Tests
{
    ...
    {
        [Test]
        public async Task RazorPages_5_Second_Cache_Intime_Test()
        {
            using var host = await new HostBuilder()
                .ConfigureWebHost(webHost =>
                {
                    ...
                    {
                        services.AddRazorPages().AddRespCache(opt =>
                        {
                            opt.UseMemoryCache();
        ...
        [Test]
        public async Task RazorPages_5_Second_Cache_Overtime_Test()
        {
            using var host = await new HostBuilder()
                .ConfigureWebHost(webHost =>
                {
